...
class VisitorOutOfLimits(Exception):
    pass
...
class IntegerRange:
    ...
    def __get__(self, instance: SlideLimitationValidator, owner: Any) -> int:
        return getattr(instance, self.protected_name)

    def __set__(self, instance: SlideLimitationValidator, value: int) -> None:
        if not (self.min_amount <= value <= self.max_amount):
            raise VisitorOutOfLimits("Noone gonna see this")
